...
#ifndef __UIF_UI_SETMONTHMENUTABLE_H__
#define __UIF_UI_SETMONTHMENUTABLE_H__

#include "UIFramework/UIView.h"

class SetMonthMenuTable : public UIView::Array
{
public:
    /**
...
#endif // __UIF_UI_SETMONTHMENUTABLE_H__
