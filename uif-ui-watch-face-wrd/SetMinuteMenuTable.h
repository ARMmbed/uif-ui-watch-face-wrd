...
#ifndef __UIF_UI_SETMINUTEMENUTABLE_H__
#define __UIF_UI_SETMINUTEMENUTABLE_H__

#include "UIFramework/UIView.h"

class SetMinuteMenuTable : public UIView::Array
{
public:
    /**
...
#endif // __UIF_UI_SETMINUTEMENUTABLE_H__
